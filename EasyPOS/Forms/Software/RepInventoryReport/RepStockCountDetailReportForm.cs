...
namespace EasyPOS.Forms.Software.RepInventoryReport
{
    public partial class RepStockCountDetailReportForm : Form
    {
        ...
        private void buttonGenerateCSV_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (dialogResult == DialogResult.OK)
                {
                    ...
                    File.WriteAllText(createDirectorySTCSV.FullName + "\\StockCountDetailReport_" + DateTime.Now.ToString("yyyyMMdd_hhmmss") + ".csv", csv.ToString(), Encoding.GetEncoding("utf-8"));
        ...
        {
            new RepStockCountDetailReportPDFForm(startDate, endDate);
        }
    }
}
