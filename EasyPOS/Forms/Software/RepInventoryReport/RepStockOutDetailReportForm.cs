...
namespace EasyPOS.Forms.Software.RepInventoryReport
{
    public partial class RepStockOutDetailReportForm : Form
    {
        ...
        private void buttonGenerateCSV_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (dialogResult == DialogResult.OK)
                {
                    ...
                    File.WriteAllText(createDirectorySTCSV.FullName + "\\StockOutDetailReport_" + DateTime.Now.ToString("yyyyMMdd_hhmmss") + ".csv", csv.ToString(), Encoding.GetEncoding("utf-8"));
        ...
        {
            new RepStockOutDetailReportPDFForm(startDate, endDate);
        }
    }
}
