...
{
    public partial class TrnPOSReturnReportForm : Form
    {
        public Int32 trnSalesId = 0;

        public TrnPOSReturnReportForm(Int32 salesId)
        {
            InitializeComponent();
            trnSalesId = salesId;
            ...
            {
                printDocumentReturnReport.DefaultPageSettings.PaperSize = new PaperSize("Official Receipt", 175, 1000);
                printDocumentReturnReport.Print();
            }
        }
        ...
        private void printDocumentReturnReport_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            // Return Report Title
            // ===================
            String officialReceiptTitle = "R E T U R N   R E P O R T";
